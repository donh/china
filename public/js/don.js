		...
		*/
		datasets : [{
			...
			data : [0.463, 0.492, 0.528, 0.583, 0.695, 0.858, 0.963, 1.11, 
				...
				16.50, 20.17, 23.71, 25.61, 30.02, 35.20, 38.42, 41.98
			]
		},
	]};
	var options = {
		...
		*/
		datasets : [{
			...
			data : [0.455, 0.489, 0.532, 0.596, 0.721, 0.902, 1.03, 1.21, 
				...
				21.63, 26.58, 31.40, 34.09, 40.15, 47.31, 51.89, 56.70
			]
		},
	]};
	var options = {
		...
		*/
		datasets : [{
			...
			data : [0.057, 0.074, 0.077, 0.086, 0.120, 0.207, 0.258, 0.308, 
				...
				14.10, 16.69, 17.99, 15.06, 20.17, 23.64, 25.10, 26.70
			]
			/*
...
function income() {
	...
	var myLine = new Chart(document.getElementById("chart_income").getContext("2d")).Line(data, options);
}
...
function currentPageFormatter(event) {
	...
	if (slidenumber) {
		//console.log(slidenumber.innerHTML);
		formattedStr = slidenumber.innerHTML;
	}
	return formattedStr;
}
