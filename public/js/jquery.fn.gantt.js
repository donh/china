        ...
        */
        ...
        var core = {
            ...
            leftPanel: function (element) {
                ...
                $.each(element.data, function (i, entry) {
                    if (i >= element.pageNum * settings.itemsPerPage && i < (element.pageNum * settings.itemsPerPage + settings.itemsPerPage)) {
                        entries.push('<div class="row_gantt name row' + i + (entry.desc ? '' : ' fn-wide') + '" id="rowheader' + i + '" offset="' + i % settings.itemsPerPage * tools.getCellSize() + '">');
                        entries.push('<span class="fn-label' + (entry.cssClass ? ' ' + entry.cssClass : '') + '">' + entry.name + '</span>');
                        entries.push('</div>');

                        if (entry.desc) {
                            entries.push('<div class="row_gantt desc row' + i + ' " id="RowdId_' + i + '" data-id="' + entry.id + '">');
            ...
            rightPanel: function (element, leftPanel /* <- never used? */) {
                ...
                var yearArr = ['<div class="row_gantt"/>'];
                var daysInYear = 0;

                var monthArr = ['<div class="row_gantt"/>'];
                var daysInMonth = 0;
                ...
                switch (settings.scale) {
                    ...
                    case "hours":
                        ...
                        dataPanel.append($('<div class="row_gantt"/>').html(dayArr.join("")));
                        dataPanel.append($('<div class="row_gantt"/>').html(dowArr.join("")));
                        dataPanel.append($('<div class="row_gantt"/>').html(horArr.join("")));
                    ...
                    case "weeks":
                        ...
                        yearArr = ['<div class="row_gantt"/>'];
                        monthArr = ['<div class="row_gantt"/>'];
                        var year = range[0].getFullYear();
                        var month = range[0].getMonth();
                        var day = range[0];
                    ...
                    default:
                        ...
                        dataPanel.append(yearArr.join(""));
                        dataPanel.append(monthArr.join(""));
                        dataPanel.append($('<div class="row_gantt" style="margin-left: 0;" />').html(dayArr.join("")));
                        dataPanel.append($('<div class="row_gantt" style="margin-left: 0;" />').html(dowArr.join("")));
        ...
        var tools = {
            ...
            getCellSize: function () {
                if (!tools._getCellSize) {
                    $("body").append(
                        $('<div style="display: none; position: absolute;" class="fn-gantt" id="measureCellWidth"><div class="row_gantt"></div></div>')
                    );
